...
public class HistDataPcfLineConverter extends PcfFileLineConverter {
	...
	public static HistDataPcfLineConverter createM1(IPcfSourceProviderManager manager, HistDataInstrument instrument) {
	...
	public static HistDataPcfLineConverter createTick(IPcfSourceProviderManager manager, HistDataInstrument instrument) {
	...
	public HistDataPcfLineConverter(IPcfSourceProviderManager manager, IPriceCandleLineParser parser, ILineFilter filter) {
