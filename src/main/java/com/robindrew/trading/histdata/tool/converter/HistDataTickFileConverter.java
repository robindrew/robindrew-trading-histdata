...
public class HistDataTickFileConverter {

	private static final Logger log = LoggerFactory.getLogger(HistDataTickFileConverter.class);
	...
	public static void main(String[] array) {
		...
		HistDataTickFileConverter converter = new HistDataTickFileConverter();
